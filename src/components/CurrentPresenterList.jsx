    ...
    <div className="bg-gray-50 pt-9 lg:h-96">
      <div className="text-center lg:mb-24 md:mb-0">
        ...
        <p className="mx-auto mt-5 max-w-xl text-xl text-gray-500">
          ...
          across many internationally renowned companies. In 2016 he worked for
          Johnson & Johnson in their consumer healthcare division developing
          products and in 2017 he worked in the Janssen Pharmaceutical Companies
          of Johnson & Johnson conducting Biologics Research. He is currently a
          ...
          products that improve people's lives. He also recently received his
          B.S in chemical engineering at Drexel University in 2018.
        </p>
      </div>
    </div>
  );
