    ...
    <div className="bg-gray-50 pt-9 lg:h-96">
      <div className="text-center lg:mb-24 md:mb-0">
        ...
        <p className="mx-auto mt-5 max-w-xl text-xl text-gray-500">
          On October 13th, at 2:20 in room A13, we plan to have our second
          presenter Melvin Jose! Mr. Jose has held a multitude of positions
          across many internationally renowned companies. He recently got his
          B.S. in Chemical Engineering from Drexel University during which he
          completed a Co-Op program with Johnson & Johnson in their consumer
          healthcare division. In 2017, he also did a Co-Op
