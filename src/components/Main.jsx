              ...
              <div className="lg:py-24">
                <h1 className="mt-4 text-4xl font-bold tracking-tight text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                  <span className="block">
                    Welcome To The CRS Technology Club Website!
                  </span>
                ...
                <p className="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">
                  ...
                  and hands-on experiences. Membership is open to all students
                  in grades 9-12 who are interested in working on experiments
                  and projects. Student projects are often displayed in the
                  school showcase. Meetings are held monthly.
                </p>
                <p className="mt-2 text-base text-gray-400 sm:text-xl lg:text-lg xl:text-xl">
                  To be updated on the latest news and events join our
                  newsletter below!
                </p>
